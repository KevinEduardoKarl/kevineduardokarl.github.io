...
# The contribution of soil management practices as a share global greenhouse gas emissions is growing.

Let's get the details out of the way first. This data is taken from the Food and Agriculture Organization of the United Nations (FAO), and contains data from 1961-2017 (most recent data available). There's an obvious bump in greenhouse gas (GhG) emissions in 1990- not because the world's farmers suddenly went wild for a year, but because the FAO included a couple of new indicators to their overall tally at that time (including "cultivation of organic soil", which is negligible and not included in this analysis).

The main trends here are clear, while most indicators are clearly rising, the two main contributors— enteric fermentation and agricultural soils— are increasing at different rates. At the current rate, it appears that agricultural soil management will catch, and then surpass, enteric fermentation as the number one cause of GhG emissions from agriculture.

# What is enteric fermentation? What is included in "agricultural soils"? ### The distinction is not as simple as animal agriculture vs. cropland agriculture.
